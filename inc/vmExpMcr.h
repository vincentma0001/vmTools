...
#ifndef __VM_EXPMCR_H__
#define __VM_EXPMCR_H__
...
#if defined (_V_PLATFORM) && (_V_PLATFORM==__V_PLATFORM_WIN__) && !defined(__CWINSEH_H__)
#	error this file need #include <vmLibExp/CWinSeh.h>
#endif // __CWINSEH_H__

#if defined (_V_PLATFORM) && (_V_PLATFORM==__V_PLATFORM_WIN__) && !defined(__CWINSEHEXP_H__)
