...
public:
    size_t Write( const void* const cpSrc, const size_t csztDataLen, const size_t csztOffset=0 )
    {
        ...
        void* lpPos = (char*)mpFileView+csztOffset;
    ...
    long Initialize( const vChar* const cpName, const size_t csztSize )
    {
        msztSize = csztSize;
    ...
    long Create( const vChar* const  cpName,         const unsigned long cdwProtect, 
    ...
    long Open(const vChar* const cpName, const unsigned long cdwDesiredAccess, const bool cbInheritHandle = false)
    {
