...
inline int v_vsprintf(tchar* const pDst, const size_t csztDstSize, const tchar* const cpFmt, va_list vList)
{
    ...
    if (liRet < 0) { vCheckErrCode(v_memmove()); };
