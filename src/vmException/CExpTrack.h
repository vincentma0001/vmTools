...
// type define :
public:
    typedef std::list<CException>                  tlist;
    typedef std::list<CException>::iterator        tItor;
    typedef std::list<CException>::const_iterator  ctItor;
/////////////////////////////////////////////////////////////////////////////////////
// data members :
private:
    tlist           mlistExp;                   // 异常列表
...
public:
    void Add( const CException& exp );          // 添加一个异常对象
