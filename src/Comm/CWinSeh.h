...
// Brief 		: 
// Auther 		: v.m.
// Create time 	: 18/12/2015 20:25:56
// Modify time 	: 18/12/2015 20:25:56
// Note 		:
//
/////////////////////////////////////////////////////////////////////////////////////////
//
...
// include file
#ifndef _WINDOWS_
#   error This file need windows.h
#endif
#include <eh.h>
...
/////////////////////////////////////////////////////////////////////////////////////////
//
// class define : CWinSeh
//        Notes : 此类封装有关windows中有关SEH操作
//
/////////////////////////////////////////////////////////////////////////////////////////
class CWinSeh
{
...
public:
    // Construct define
	CWinSeh( PEXCEPTION_POINTERS pep );                     
    // Destruct define
	virtual ~CWinSeh(){};			                                
public:
    // 获取异常描述
    const char* GetExpDes( const DWORD dwLanguage=LANG_ENGLISH );   
    // 获取异常代码
    DWORD GetExpCode();
...
public:
    ...
    // 获取异常描述
    static const char* SGetExpDes( const DWORD dwExpCode, const DWORD dwLanguage=LANG_ENGLISH );

private:
    // 获取英文异常描述
    static const char* GetExpDesEN( const DWORD dwExpCode );
    // 获取中文异常描述
    static const char* GetExpDesCN( const DWORD dwExpCode );

}; // End of class CSeToCe
/////////////////////////////////////////////////////////////////////////////////////////
