...
//#include <vmTools/CWinApis.h>
#include <vmTools/CWinKernal.h>
...
//
/////////////////////////////////////////////////////////////////////////////////////////
class CWinConsole : public CWinKernal
{
/////////////////////////////////////////////////////////////////////////////////////////
// Typedefs :
public:
...
public:
    ...
    {
        int liSceenWigt = ::GetSystemMetrics(SM_CXSCREEN);
        int liSceenHigh = ::GetSystemMetrics(SM_CYSCREEN);
