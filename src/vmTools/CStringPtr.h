...
// Parameter : Param1                                    - [O] # add param1 value notes #
//           : Param2                                    - [I] # add param2 value notes #
inline bool CStringPtr::Cmp(const tchar* const cpSrc, const size_t csztDataLen, const size_t csztBufOffSet )
{
    tchar* lpPos = mpBuf + csztBufOffSet;
...
// Parameter : Param1                                    - [O] # add param1 value notes #
//           : Param2                                    - [I] # add param2 value notes #
inline bool CStringPtr::iCmp(const tchar* const cpSrc, const size_t csztDataLen, const size_t csztBufOffset )
{
