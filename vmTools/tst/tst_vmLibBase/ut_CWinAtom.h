...
{
    bool lbRet = false;
//  Test for CWinAtom<bool>
//              [F] bool operator = ( const bool obj )
//              [F] operator bool ( )

    vm::CWinAtom<bool> loAtom(false);
    vm::utLogLine( vT("lAtom( CWinAtom<bool> ) : %s"), bool(loAtom)==true?vT("true"):vT("false") );
    loAtom = true;
    vm::utLogLine( vT("lAtom( CWinAtom<bool> ) : %s"), bool(loAtom)==true?vT("true"):vT("false") );
    bool lbRet1 = loAtom == true;
    vm::utLogLine( vT("lAtom( CWinAtom<bool> ) : %s == true(%s)"), bool(loAtom)==true?vT("true"):vT("false"), lbRet1==true?vT("true"):vT("false") );
    bool lbRet2 = loAtom != true;
    vm::utLogLine( vT("lAtom( CWinAtom<bool> ) : %s == true(%s)"), bool(loAtom)==true?vT("true"):vT("false"), lbRet2==true?vT("true"):vT("false") );
